...
sNET='en6: USB 10/100/1000 LAN'  # // network adaptor to use for bridged mode eg: 'en0: Wi-Fi'
...
iCLUSTERA_IP_VAULT_CLASS_D=174  # // Vault A Leader IP starting D class (increment or de) minus -1
...
#		haproxy_node.vm.provision "file", source: "#{sPTH}/3.install_haproxy.sh", destination: "#{sHOME}/install_haproxy.sh"
